  ...
  const steps = [
    {
      ...
      title: "Dijital Stok Yönetimi",
      description: "Buzdolabınızdaki ürünleri manuel olarak veya barkod ile sisteme tanımlayın. Algoritmamız son kullanma tarihlerini ve besin gruplarını anlık analiz etsin."
    },
    {
      id: "02",
      icon: <Sparkles className="w-8 h-8 text-accent" />, // Accent Yellow/Gold
      title: "Yapay Zeka Sentezi",
      description: "Google Gemini destekli motorumuz, elinizdeki malzemelerle oluşturulabilecek binlerce kombinasyonu tarayarak damak tadınıza en uygun eşleşmeleri bulur."
    },
    {
      id: "03",
      icon: <ChefHat className="w-8 h-8 text-primary-600" />,
      title: "Gurme Sonuçlar",
      description: "Sadece karnınızı doyuran değil; besin değerleri dengelenmiş, israfı önleyen ve şef teknikleri içeren reçetelerle mutfağınızda harikalar yaratın."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-stone-900 mb-4 tracking-tight">
            Üç Adımda <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-primary-400">Akıllı Mutfak</span> Deneyimi
          </h2>
          <p className="text-stone-600 text-lg leading-relaxed">
            Karmaşık yemek planlama süreçlerini teknolojiyle sadeleştiriyoruz. Kiler.ai, mutfağınızı profesyonel bir veri tabanına dönüştürür.
          </p>
        </div>
